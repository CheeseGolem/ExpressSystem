...
#else
        private string appId = "wx0472f6e059661ec4";
        private string appSecret = "f8ef69d028a3167d18951a3ac306d927";
#endif
...
测试完成后，您可以登陆公众号后台取消授权。",
        ...
        public override IResponseMessageBase OnVoiceRequest(RequestMessageVoice requestMessage)
        {
            ...
            var uploadResult = Senparc.Weixin.MP.AdvancedAPIs.MediaApi.UploadTemporaryMedia(appId, UploadMediaFileType.image, Server.GetMapPath("~/Images/Logo.jpg"));
